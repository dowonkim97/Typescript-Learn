...
/*
const person = { name: "kim", age: 25, gender: "male" };
 */

/*
const kim = new Human("kim", 25, "male");
...
const genesisBlock: Block = new Block(0, "3409249", "", "Hello", 123456);

let blockchain: Block[] = [genesisBlock];

const getBlckchain = (): Block[] => blockchain;
